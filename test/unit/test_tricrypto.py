...
def test_tweak_price(
    ...
    n_coins = 3
    assume(i != j)
    # withdraw only one coin (up to 1/n of total deposits)
    assume(lp_amount < vyper_tricrypto.totalSupply() // n_coins)
    ...
    # pass in non-None p_i to trip the CalculationError
