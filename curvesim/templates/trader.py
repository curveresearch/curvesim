...
from curvesim.logging import get_logger # why is this here?
from curvesim.utils import dataclass

logger = get_logger(__name__) # why is this here?
...
class Trader(ABC):
    ...
    def process_time_sample(self, pool, *args): # this may need to take in individual pools
        """
